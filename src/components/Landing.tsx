      ...
      <nav className={loaded ? "fade-in" : ""} style={{
        ...
        <div className="desktop-nav" style={{ display: "flex", alignItems: "center", gap: 28 }}>
          ...
          {user ? (
            ...
            <>
              <a href="https://auth.bsvibe.dev/signup?redirect_uri=https%3A%2F%2Fbsvibe.dev%2Fauth%2Fcallback" style={{
                padding: "6px 16px",
                borderRadius: 8,
              ...
              <a href="https://auth.bsvibe.dev/login?redirect_uri=https%3A%2F%2Fbsvibe.dev%2Fauth%2Fcallback" className="nav-link" style={{ fontSize: "0.8125rem", fontWeight: 500 }}>{l.nav.login}</a>
            </>
          )}
        </div>
      ...
      {menuOpen && (
        <div style={{
          ...
          {user ? (
            ...
            <a href="https://auth.bsvibe.dev/login?redirect_uri=https%3A%2F%2Fbsvibe.dev%2Fauth%2Fcallback" className="nav-link" style={{ fontSize: "0.875rem" }}>{l.nav.login}</a>
          )}
        </div>
      )}
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 720 }}>
          ...
          <div className={loaded ? "fade-up" : ""} style={{
            ...
            <a href="https://auth.bsvibe.dev/signup?redirect_uri=https%3A%2F%2Fbsvibe.dev%2Fauth%2Fcallback" className="cta-secondary" style={{
              display: "inline-block",
              padding: "13px 28px",
              borderRadius: 10,
